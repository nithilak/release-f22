...
class SquareMaze {
    ...
    */
     ...
     * @param x The x coordinate of the current cell
     * @param y The y coordinate of the current cell
     * @param dir Either 0 (right) or 1 (down), which specifies which wall to set (same 
     ...
     * (width*10+1,height*10+1). where height and width were the arguments to makeMaze. 
     ...
     * ((x+1)*10,y*10+k) for k from 0 to 10. If the bottom wall exists, then blacken the 
     ...
     * until you get to the end of the solution vector, so that your output looks 
     * analogous the above picture.
     * 
