...
add_test( [==[List::ListIterator::operator-- (post-increment) returns tail_ from end]==] /workspaces/cs225env/release-f22/mp_clean_lists/build/test [==[List::ListIterator::operator-- (post-increment) returns tail_ from end]==]  )
set_tests_properties( [==[List::ListIterator::operator-- (post-increment) returns tail_ from end]==] PROPERTIES WORKING_DIRECTORY /workspaces/cs225env/release-f22/mp_clean_lists/build)
add_test( [==[List::ListIterator::operator-- (pre-increment) returns tail_ from end]==] /workspaces/cs225env/release-f22/mp_clean_lists/build/test [==[List::ListIterator::operator-- (pre-increment) returns tail_ from end]==]  )
set_tests_properties( [==[List::ListIterator::operator-- (pre-increment) returns tail_ from end]==] PROPERTIES WORKING_DIRECTORY /workspaces/cs225env/release-f22/mp_clean_lists/build)
...
add_test( [==[List::sort simple #3]==] /workspaces/cs225env/release-f22/mp_clean_lists/build/test [==[List::sort simple #3]==]  )
set_tests_properties( [==[List::sort simple #3]==] PROPERTIES WORKING_DIRECTORY /workspaces/cs225env/release-f22/mp_clean_lists/build)
add_test( [==[List::sort simple #4]==] /workspaces/cs225env/release-f22/mp_clean_lists/build/test [==[List::sort simple #4]==]  )
set_tests_properties( [==[List::sort simple #4]==] PROPERTIES WORKING_DIRECTORY /workspaces/cs225env/release-f22/mp_clean_lists/build)
add_test( [==[List::sort simple #5]==] /workspaces/cs225env/release-f22/mp_clean_lists/build/test [==[List::sort simple #5]==]  )
set_tests_properties( [==[List::sort simple #5]==] PROPERTIES WORKING_DIRECTORY /workspaces/cs225env/release-f22/mp_clean_lists/build)
add_test( [==[List::sort simple #6]==] /workspaces/cs225env/release-f22/mp_clean_lists/build/test [==[List::sort simple #6]==]  )
set_tests_properties( [==[List::sort simple #6]==] PROPERTIES WORKING_DIRECTORY /workspaces/cs225env/release-f22/mp_clean_lists/build)
add_test( [==[List::sort simple #7]==] /workspaces/cs225env/release-f22/mp_clean_lists/build/test [==[List::sort simple #7]==]  )
set_tests_properties( [==[List::sort simple #7]==] PROPERTIES WORKING_DIRECTORY /workspaces/cs225env/release-f22/mp_clean_lists/build)
